...
class _TIMUIKitFileElemState extends TIMUIKitState<TIMUIKitFileElem> {
  ...
  Future<bool> hasFile() async {
    ...
    String savePath = TencentDeskUtils.checkString(model.getFileMessageLocation(widget.messageID)) ??
              ...
              onTap: () async {
                try {
                  ...
                  if (checkIsWaiting()) {
                    onTIMCallback(
                      TIMCallback(
                          type: TIMCallbackType.INFO, infoRecommendText: TDesk_t("已加入待下载队列，其他文件下载中"), infoCode: 6660413),
                    );
                    return;
                  } else {
