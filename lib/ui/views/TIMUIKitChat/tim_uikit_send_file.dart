...
sendFileWithConfirmation(
  ...
  final option1 = conversation.showName ?? (conversationType == ConvType.group ? TDesk_t("群聊") : TDesk_t("对方"));
...
class TIMUIKitSendFile extends TIMUIKitStatelessWidget {
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    final option1 = conversation.showName ?? (conversationType == 2 ? TDesk_t("群聊") : TDesk_t("会话"));
                ...
                children: [
                  Expanded(
                    ...
                    children: [
                      ...
                      Text(
                        TDesk_t_para("发送给{{option1}}", "发送给$option1")(option1: option1),
